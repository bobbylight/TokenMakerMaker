...
%{
	...
	public Token getTokenList(Segment text, int initialTokenType, int startOffset) {
		...
		switch (initialTokenType) {
			@possible.mlc.switch.case@
			@possible.doc.switch.case@
			default:
				state = Token.NULL;
		}
...
@possible.char.macros@
@possible.string.macros@
...
@possible.string.state.definition@
@possible.char.state.definition@
@possible.mlc.state.definition@
@possible.doc.state.definition@
@possible.eol.state.definition@
